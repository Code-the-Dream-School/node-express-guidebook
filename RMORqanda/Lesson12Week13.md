...
3. **Define a Schema**: A schema defines the structure of your documents, including field types, validation, and default values. It acts as a blueprint for your MongoDB collections.
